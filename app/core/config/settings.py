...
class Settings(BaseSettings):
    ...
    @classmethod
    def _normalize_insecure_allow_remote_no_auth_host_cidrs(cls, value: StringListInput) -> list[str]:
        return _normalize_cidr_list(
            value,
            field_name="insecure_allow_remote_no_auth_host_cidrs",
            invalid_label="insecure remote no-auth host CIDR",
        )
